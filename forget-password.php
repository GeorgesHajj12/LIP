...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $message = '<p>'.'To reset your password, please click on the link below.'.'<br> <a href="reset-password.php?email='.$_POST['cust_email'].'&token='.$token.'">Click here</a>';
        
        $to      = $_POST['cust_email'];
        $subject = 'PASSWORD RESET REQUEST - LIP.COM';
