...
<?php
	$statement = $pdo->prepare("UPDATE tbl_payment SET payment_status=? WHERE pay_id=?");
	$statement->execute(array($_REQUEST['task'],$_REQUEST['id']));
	$statement1 = $pdo->prepare("SELECT customer_FirstName,customer_email FROM tbl_payment WHERE payment_status=? and pay_id=?");
	...
	$mybody='Your payment is now completed';
