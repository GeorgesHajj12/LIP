...
$statement = $pdo->prepare("UPDATE products SET p_total_view=? WHERE p_id=?");
...
if(isset($_POST['form_add_to_cart'])) {
	...
	if($_POST['p_qty'] > $current_p_qty):
		$temp_msg = 'Sorry! No such quantity in stock';
		?>
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'This product is already added to the shopping cart. U can update your quantity in cart';
        } else {
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT * FROM products WHERE ecat_id=? AND p_id!=?");
