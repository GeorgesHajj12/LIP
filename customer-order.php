...
<div class="page">
    <div class="container">
        <div class="row">
            ...
            $statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE customer_email=? ORDER BY pay_id DESC");
            ...
            $statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE customer_email=? ORDER BY pay_id DESC LIMIT $start, $limit");
            $statement->execute(array($_SESSION['customer']['cust_email']));
