          ...
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<td><?php if($row['subs_active']==1) {echo 'Active';} else {echo 'Inactive';} ?></td>
									<td>
										<a href="subscriber-change-status.php?id=<?php echo $row['subs_id']; ?>" class="btn btn-success btn-xs">Change Status</a>
									</td>
