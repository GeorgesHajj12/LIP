			    ...
			    else
			    {
				    ...
				    else
				    {
				    	...
				    	else
				    	{
							...
							$verification_url ='verify.php?email='.$to.'&key='.$key;
...
This link will be active only for 24 hours.
					';
							...
							sendEmailKK('',$_POST["email_subscribe"],'Thank you for subscribing in our newsletter ');
							$success_message1 = 'Thank u for subscribing.';
				    	}
				    }
			    }
			}
				...
				<form action="" method="POST">
					...
					<div class="input-group">
			        	<input type="email" class="form-control" placeholder="<?php echo 'Enter Your Email Address'; ?>" name="email_subscribe">
			         	...
			         	<input class="btn btn-theme" type="submit" name="form_subscribe"><?php echo 'Subscribe'; ?></input>
			         	</span>
			        </div>
				</div>
				</form>
