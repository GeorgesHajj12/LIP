...
<div class="page">
    <div class="container">
        <div class="row">
            ...
            $adjacents = 5;
            $statement = $pdo->prepare("SELECT * FROM products WHERE p_is_active=? AND p_name LIKE ?");
            ...
            $statement = $pdo->prepare("SELECT * FROM products WHERE p_is_active=? AND p_name LIKE ? LIMIT $start, $limit");
            $statement->execute(array(1,$search_text));
            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
